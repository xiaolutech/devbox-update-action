...
export class PackageScanner {
	...
	constructor(
		configPath: string = FILES.DEVBOX_CONFIG,
		updateLatest: boolean = false,
	) {
		this.configPath = configPath;
		this.versionQueryService = createVersionQueryService(updateLatest);
	}
...
export function createPackageScanner(
	...
	return new PackageScanner(configPath, updateLatest);
}
 ...
 * @returns Array of parsed package information
 */
export async function scanDevboxPackages(
	updateLatest: boolean = false,
): Promise<ParsedPackage[]> {
	const scanner = createPackageScanner(undefined, updateLatest);
 ...
 * @returns Array of UpdateCandidate objects
 */
export async function scanForDevboxUpdates(
	updateLatest: boolean = false,
 ...
 */
export async function generateDevboxUpdateSummary(
	updateLatest: boolean = false,
